...
- Clean-child launch result: absolute interpreter, exact `-I -B -S -P`, sanitized environment, snapshot cwd, local-module origin/digest audit, direct operational entrypoint blocked, and recovery snapshot mutation not performed:
