...
- Repository-external validator source-snapshot path, 91-member exact-tree/read-only result, caller-retained manifest payload/file SHA-256 pins, and pre/post identity/byte recheck evidence:
