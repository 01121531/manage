...
class PlatformDesktopBoundaryTests(unittest.TestCase):
    ...
    def test_unexpected_clipboard_retry_schedule_error_keeps_close_retryable(
        self,
    ) -> None:
        instance = self._event_app()
        secret = "246810"
        ...
        instance.root.after = mock.Mock(
            side_effect=RuntimeError("unexpected scheduling failure")
        )
    ...
    def test_code_widget_error_still_schedules_sensitive_cleanup(self) -> None:
        instance = self._event_app()
        secret = "246810"
        instance._client = mock.Mock(is_authenticated=True)
        instance._write_clipboard = PlatformDesktopApp._write_clipboard.__get__(
    ...
    def test_unexpected_clipboard_write_error_still_schedules_code_cleanup(
        self,
    ) -> None:
        instance = self._event_app()
        secret = "246810"
        ...
        instance.root.clipboard_append = mock.Mock(
            side_effect=RuntimeError("unexpected clipboard write failure")
        )
    ...
    def test_clipboard_sequence_error_still_tracks_and_clears_written_code(
        self,
    ) -> None:
        instance = self._event_app()
        secret = "246810"
        ...
        with mock.patch(
            ...
            side_effect=RuntimeError("clipboard sequence unavailable"),
        ):
            instance._events.put(
                (1, "code", MailCodeSnapshot(status="consumed", code=secret))
            )
            ...
            self.assertEqual(instance._current_code, secret)
            self.assertEqual(instance._clipboard_owner, (secret, None))
            self.assertEqual(instance.root.clipboard, secret)
            cleanup = next(
                callback
                for _delay, callback, _args in instance.root.scheduled
    ...
    def test_close_status_error_does_not_block_clipboard_retry(self) -> None:
        instance = self._event_app()
        secret = "246810"
        owner = (secret, None)
        instance._clipboard_owner = owner
        instance._clipboard_cleanup_failed = [owner]
        instance._destroy_pending = True
        instance.root.clipboard = secret
        instance.status_label.configure = mock.Mock(
            side_effect=RuntimeError("status widget unavailable")
        )
    ...
    def test_shutdown_clipboard_retry_ignores_ui_errors(self) -> None:
        instance = self._event_app()
        secret = "246810"
        owner = (secret, None)
        instance._clipboard_owner = owner
        ...
        instance._retry_shutdown_clipboard_cleanup()
    ...
    def test_card_retry_button_error_gets_deferred_retry(self) -> None:
        instance = self._event_app()
        details = "4111111111111111\t12/30"
        instance._client = mock.Mock(is_authenticated=True)
        instance._card_allocation_id = "allocation-1"
        ...
        instance._discard_card_after_clipboard_failure()
        delay, retry, args = instance.root.scheduled.pop()

        self.assertEqual(delay, 0)
        self.assertIsNone(instance._current_card_clipboard)
        self.assertNotEqual(instance.copy_card_button.values.get("state"), "normal")
    ...
    def test_workflow_ui_error_cannot_skip_logged_out_capabilities(self) -> None:
        instance = self._event_app()
        ...
        instance.business_entry.configure(state="normal")
        instance.login_button.configure(state="disabled")
        instance.workflow_label.configure = mock.Mock(
            side_effect=RuntimeError("workflow widget unavailable")
        )
    ...
    def test_unexpected_lock_compensation_error_releases_single_flight(self) -> None:
        instance = self._event_app()
        instance._client = mock.Mock(is_authenticated=True)
        cleanup = mock.Mock(side_effect=RuntimeError("unexpected cleanup failure"))
        transition = mock.Mock()
        transition.cancel.return_value = cleanup
        instance._task_transition = transition
    ...
    def test_stale_terminal_cleanup_start_failure_exposes_same_retry(self) -> None:
        instance = self._event_app()
        cleanup = mock.Mock()
        instance._terminal_task_cleanup_action = cleanup
        instance._terminal_task_cleanup_task_id = "task-1"
        ...
        self.assertIsNotNone(instance._terminal_task_cleanup_thread)
    ...
    def test_unlock_preserves_failed_terminal_cleanup_as_only_resource_action(
        self,
    ) -> None:
        instance = self._event_app()
        instance._locked = True
        instance._client = mock.Mock(is_authenticated=True)
        instance._active_task_recovery = self._recovery_snapshot()
        instance._terminal_task_cleanup_action = mock.Mock()
        instance._terminal_task_cleanup_task_id = "task-1"
        instance._terminal_task_cleanup_outcome = "completed"
        instance._terminal_task_cleanup_in_progress = False
    ...
    def test_stale_session_restore_start_failure_clears_action(self) -> None:
        instance = self._event_app()
        instance._client = mock.Mock()
        instance._client.has_saved_refresh_session.return_value = True
    ...
    def test_unexpected_update_close_schedule_failure_closes_synchronously(self) -> None:
        instance = self._event_app()
        manifest = mock.Mock(sha256="8" * 64)
        package = Path("verified-update.exe")
        instance._pending_update_install = (manifest, package)
