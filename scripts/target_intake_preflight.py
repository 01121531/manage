...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments.command == "verify-generation-lineage":
        ...
        print(
            ...
            f"{lineage.receipt['validation_context']['validator_contract']['execution_profile']['launcher_interpreter_sha256'] or 'not-applicable'} "
            ...
            "generation-validator-on-disk-source-inventory=67-whole-file-sha256-matched "
            ...
            "authoring-validation-context-anchor-validity-revocation=unverified "
            "authoring-trusted-timestamp-receipt=unverified "
            "authoring-provider-head=unverified "
            ...
            "authoring-validator-loaded-runtime-code-identity=unverified "
            "authoring-validator-original-runtime-identity=unverified "
    ...
    if arguments.command == "init":
        ...
        print(
            ...
            "generation-validator-launcher-interpreter-sha256="
            f"{validator_contract['execution_profile']['launcher_interpreter_sha256'] or 'not-applicable'} "
    ...
    if arguments.command == "register":
        ...
        print(
            ...
            "generation-validator-launcher-interpreter-sha256="
            f"{historical_validator_contract['execution_profile']['launcher_interpreter_sha256'] or 'not-applicable'} "
